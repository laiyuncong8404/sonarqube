...
public class PluginDaoTest {
  ...
  public void selectByKey() {
    ...
    assertThat(plugin.get().getKey()).isEqualTo("java");
    assertThat(plugin.get().getBasePluginKey()).isNull();
    assertThat(plugin.get().getJarMd5()).isEqualTo("aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa");
  ...
  public void insert() {
    ...
    underTest.insert(db.getSession(), new PluginDto()
      ...
      .setJarMd5("cccccccccccccccccccccccccccccccc")
      .setCreatedAt(1L)
      .setUpdatedAt(2L));
    ...
    assertThat(plugin.get().getKey()).isEqualTo("javascript");
    assertThat(plugin.get().getBasePluginKey()).isEqualTo("java");
    assertThat(plugin.get().getJarMd5()).isEqualTo("cccccccccccccccccccccccccccccccc");
  ...
  public void update() {
    ...
    assertThat(plugin.getJarMd5()).isEqualTo("abc");
